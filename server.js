...
mongoose.connect(MONGO_URI_FINAL)
    .then(() => console.log('\x1b[32m[OK]\x1b[0m Regresamos al Core Estable de Seychelles Shop.'))
...
// Volvemos a tu lista blanca original directa
...
app.listen(PORT, () => console.log(`[PRODUCTION] Revertido a Seychelles Shop Core en puerto: ${PORT}`));